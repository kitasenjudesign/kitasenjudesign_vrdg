...
class Bitmap3D extends Shape, implements IObject3D {
	...
	private function initVectors():Void {
		__vectorIn = new Vector<Float>(6, true);
		__vectorIn[5] = 1;
		__vectorOut = new Vector<Float>(6, true);
	}

	private function initVectorsBitmap():Void {
		__verticesIn = new Vector<Float>(12, true);
		__verticesOut = new Vector<Float>(12, true);
		__verticesProjected = new Vector<Float>(8, true);
		...
		__indices[4] = 2;
		__indices[5] = 3;
		__uvtData = new Vector<Float>(12, true);
		__uvtData[3] = 1;
		__uvtData[7] = 1;
		__uvtData[9] = 1;
		__uvtData[10] = 1;
