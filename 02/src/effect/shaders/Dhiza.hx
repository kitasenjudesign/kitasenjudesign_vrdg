...
class Dhiza
{
	...
	public static function getObject():Dynamic {return {	uniforms: {		"tDiffuse": { type: "t", value: null },		"vScreenSize":   { type: "v2", value: new Vector2(StageRef.stageWidth,StageRef.stageHeight) }	},
...
void main() {
	...
	// 4ピクセルごとに使用する閾値の表
	mat4 m = mat4(    vec4( 0.0,  8.0,    2.0,    10.0),    vec4( 12.0, 4.0,    14.0,   6.0),    vec4( 3.0,  11.0,   1.0,    9.0),    vec4( 15.0, 7.0,    13.0,   5.0));
