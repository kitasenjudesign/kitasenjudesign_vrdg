...
class Typography3D {
	...
	public var motifs:Map<String, Array<Dynamic>>;
	public var widths:Map<String, Float>;
	public var height:Float;

	/**
	 * Creates a new Sprite3D instance.
	 */
	public function new() {motifs = new Map<String,Array<Dynamic>>();widths = new Map<String,Float>();
	}
	 ...
	 */
	public function getMotif(char:String):Array<Dynamic> {return motifs.get(char);
	}
	 ...
	 */
	public function getWidth(char:String):Float {return widths.get(char);
	}
