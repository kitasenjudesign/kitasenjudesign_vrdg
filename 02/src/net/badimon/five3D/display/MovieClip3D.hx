...
class MovieClip3D extends Sprite3D {
	 ...
	 */
	public function new(clip:MovieClip, clippingRectangle:Rectangle = null, smoothing:Bool = true) {super();__clip = clip;__clippingRectangle = clippingRectangle;createBitmap(smoothing);
	}

	private function createBitmap(smoothing:Bool):Void {__bitmap = new Bitmap3D(null, smoothing);addChild(__bitmap);
	}
	...
	private function getCurrentFrame():Int {return __clip.currentFrame;
	}
	...
	private function getCurrentFrameLabel():String {return __clip.currentFrameLabel;
	}
	...
	private function getCurrentLabel():String {return __clip.currentLabel;
	}
	...
	private function getCurrentLabels():Array<FrameLabel> {return __clip.currentLabels;
	}
	...
	private function getCurrentScene():Scene {return __clip.currentScene;
	}
	...
	private function getEnabled():Bool {return __clip.enabled;
	}

	private function setEnabled(value:Bool):Bool {__clip.enabled = value;return __clip.enabled;
	}
	...
	private function getFramesLoaded():Int {return __clip.framesLoaded;
	}
	...
	private function getScenes():Array<Scene> {return __clip.scenes;
	}
	...
	private function getTotalFrames():Int {return __clip.totalFrames;
	}
	...
	private function getTrackAsMenu():Bool {return __clip.trackAsMenu;
	}

	private function setTrackAsMenu(value:Bool):Bool {__clip.trackAsMenu = value;return __clip.trackAsMenu;
	}
	 ...
	 */
	public function gotoAndPlay(frame:Dynamic, scene:String = null):Void {__clip.gotoAndPlay(frame, scene);
	}
	 ...
	 */
	public function gotoAndStop(frame:Dynamic, scene:String = null):Void {__clip.gotoAndStop(frame, scene);
	}
	 ...
	 */
	public function nextFrame():Void {__clip.nextFrame();
	}
	 ...
	 */
	public function nextScene():Void {__clip.nextScene();
	}
	 ...
	 */
	public function play():Void {__clip.play();
	}
	 ...
	 */
	public function prevFrame():Void {__clip.prevFrame();
	}
	 ...
	 */
	public function prevScene():Void {__clip.prevScene();
	}
	 ...
	 */
	public function stop():Void {__clip.stop();
	}
	...
	private function getClip():MovieClip {return __clip;
	}

	private function setClip(value:MovieClip):MovieClip {__clip = value;return __clip;
	}
	...
	private function getClippingRectangle():Rectangle {return __clippingRectangle;
	}

	private function setClippingRectangle(value:Rectangle):Rectangle {__clippingRectangle = value;return __clippingRectangle;
	}
	...
	private function getSmoothing():Bool {return __bitmap._smoothing;
	}

	private function setSmoothing(value:Bool):Bool {__bitmap._smoothing = value;return __bitmap._smoothing;
	}
	 ...
	 * @see #deactivate()
	 */
	public function activate():Void {addEventListener(Event.ENTER_FRAME, enterFrameHandler);
	}

	private function enterFrameHandler(event:Event):Void {var bounds:Rectangle = (__clippingRectangle == null) ? __clip.getBounds(__clip) : __clippingRectangle;if (bounds.width != 0 && bounds.height != 0) {	__bitmap._x = bounds.x;	__bitmap._y = bounds.y;	var bitmapData:BitmapData = new BitmapData(cast(bounds.width, Int), cast(bounds.height, Int), true, 0x00000000);	var matrix:Matrix = new Matrix(1, 0, 0, 1, -bounds.x, -bounds.y);	bitmapData.draw(__clip, matrix);	__bitmap._bitmapData = bitmapData;}
	}
	 ...
	 * @see #activate()
	 */
	public function deactivate():Void {removeEventListener(Event.ENTER_FRAME, enterFrameHandler);
	}
	...
	override private function getChildrenSorted():Bool {throw "The MovieClip3D class does not implement this property or method.";return false;
	}

	override private function setChildrenSorted(value:Bool):Bool {throw "The MovieClip3D class does not implement this property or method.";return false;
	}
}