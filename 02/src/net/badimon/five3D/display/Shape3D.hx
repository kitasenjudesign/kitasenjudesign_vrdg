 ...
 */
class Shape3D extends Shape, implements IObject3D {
	 ...
	 * @private
	 */
	public function askRendering():Void {__render = true;__graphics.askRendering();if (__singleSided) __renderCulling = true;if (__flatShaded) __renderShading = true;
	}
