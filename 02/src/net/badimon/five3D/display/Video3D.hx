...
class Video3D extends Bitmap3D {
	 ...
	 */
	public function new(width:Int = 320, height:Int = 240) {super();__video = new Video(width, height);
	}
	...
	private function getDeblocking():Int {return __video.deblocking;
	}

	private function setDeblocking(value:Int):Int {__video.deblocking = value;return __video.deblocking;
	}
	...
	private function getVideoWidth():Int {return __video.videoWidth;
	}
	...
	private function getVideoHeight():Int {return __video.videoHeight;
	}
	 ...
	 * @see #deactivate()
	 */
	public function attachCamera(camera:Camera):Void {__video.attachCamera(camera);
	}
	 ...
	 * @see #deactivate()
	 */
	public function attachNetStream(netstream:NetStream):Void {__video.attachNetStream(netstream);
	}
	 ...
	 */
	public function clear():Void {super.setBitmapData(null);
	}
	...
	private function enterFrameHandler(event:Event):Void {var bitmapData:BitmapData = new BitmapData(Math.ceil(__video.width), Math.ceil(__video.height), false);bitmapData.draw(__video);super.setBitmapData(bitmapData);
	}
	...
	override private function getBitmapData():BitmapData {throw "The Video3D class does not implement this property or method.";return null;
	}

	override private function setBitmapData(value:BitmapData):BitmapData {throw "The Video3D class does not implement this property or method.";return null;
	}
}