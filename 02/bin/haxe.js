...
emoji.EmojiShader.prototype = {
	init: function() {
		...
		tex.minFilter = 1003;
		tex.magFilter = 1003;
		this.uniforms = { strength : { type : "f", value : 100.0}, seed : { type : "f", value : 0.0}, counter : { type : "f", value : 0}, texture : { type : "t", value : tex}, scale : { type : "f", value : 3000.0}, posScale : { type : "v3", value : new THREE.Vector3(1.0,1.0,1.0)}, offset : { type : "v2", value : new THREE.Vector2(1 / this.animationFrameLength,0.0)}, repeat : { type : "v2", value : new THREE.Vector2(1 / this.animationFrameLength,1 / this.animationFrameLength)}};
...
emoji.Emojis.prototype = $extend(THREE.Object3D.prototype,{
	...
	,_onDown: function(e) {
		...
		if(keyCode == 39) {
			...
			if(Math.random() < 0.5) this._isCurl = true; else this._isCurl = false;
