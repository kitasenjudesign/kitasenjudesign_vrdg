...
/**
 * The HelveticaLight class contains the drawing data associated with the Helvetica Light typography.
 */
class HelveticaLight extends Typography3D {

	private static var _instance:HelveticaLight;

	/**
	 * Returns a unique HelveticaLight instance to be passed to a DynamicText3D object.
	 ...
	 */
	/*
	public static var instance(getInstance, null):HelveticaLight;

	private static function getInstance():HelveticaLight {
		if(_instance == null) _instance = new HelveticaLight();
		return _instance;
	}*/

	/**
	 * Creates a new HelveticaLight instance.
	 */
	public function new() {
		super();
	...
	private function initializeMotifsUppercase():Void {
		...
		[
			['M', [37.4, 62.4]],
			['C', [46.4, 62.4, 51.25, 65.9]],
			['C', [56.15, 69.35, 56.2, 76.2]],
			['C', [56.15, 81.85, 53.55, 85.1]],
			['C', [51.05, 88.35, 46.8, 89.65]],
			['C', [42.55, 91, 37.4, 90.9]],
			['L', [14, 90.9]],
			['L', [14, 62.4]],
			['L', [37.4, 62.4]],
			['M', [53.5, 44.5]],
			['C', [53.5, 47.9, 51.75, 50.65]],
			['C', [50, 53.35, 46.45, 54.95]],
			['C', [42.85, 56.55, 37.4, 56.6]],
			['L', [14, 56.6]],
			['L', [14, 31.1]],
			['L', [37.4, 31.1]],
			['C', [45.35, 31.1, 49.45, 34.5]],
			['C', [53.5, 37.85, 53.5, 44.5]],
			['M', [57.05, 32.4]],
			['C', [53.85, 28.55, 48.7, 26.9]],
			['C', [43.5, 25.25, 37.4, 25.3]],
			['L', [7.25, 25.3]],
			['L', [7.25, 96.7]],
			['L', [37.4, 96.7]],
			['C', [46.05, 96.6, 51.15, 94.5]],
			['C', [56.35, 92.35, 58.9, 89.1]],
			['C', [61.45, 85.85, 62.25, 82.45]],
			['C', [63.05, 79, 63, 76.4]],
			['C', [62.9, 69.35, 58.9, 64.65]],
			['C', [54.9, 60.05, 47.9, 59]],
			['L', [47.9, 58.8]],
			['C', [51.6, 58, 54.4, 55.65]],
			['C', [57.2, 53.3, 58.75, 49.9]],
			['C', [60.25, 46.6, 60.3, 42.8]],
			['C', [60.2, 36.2, 57.05, 32.4]]
		]
		);
		
		motifs.set("C", [['M',[60.95,34.25]],['C',[56.75,29.1,50.55,26.45]],['C',[44.35,23.8,37.5,23.8]],['C',[29.05,23.85,22.75,26.9]],['C',[16.4,29.9,12.2,35.1]],['C',[8,40.3,5.9,46.95]],['C',[3.8,53.65,3.8,61]],['C',[3.8,68.4,5.9,75.05]],['C',[8,81.7,12.2,86.95]],['C',[16.4,92.1,22.75,95.15]],['C',[29.05,98.15,37.5,98.2]],['C',[45.9,98.15,52.2,94.65]],['C',[58.5,91.15,62.35,84.75]],['C',[66.2,78.3,67.2,69.5]],['L',[60.4,69.5]],['C',[59.7,75.95,56.8,81.1]],['C',[53.9,86.25,49,89.3]],['C',[44.1,92.35,37.5,92.4]],['C',[30.4,92.35,25.3,89.7]],['C',[20.2,87.05,16.95,82.55]],['C',[13.65,78.05,12.15,72.5]],['C',[10.6,66.9,10.6,61]],['C',[10.6,55.1,12.15,49.55]],['C',[13.65,43.95,16.95,39.45]],['C',[20.2,35,25.3,32.3]],['C',[30.4,29.65,37.5,29.6]],['C',[42.7,29.6,47.25,31.65]],['C',[51.75,33.65,55,37.5]],['C',[58.15,41.4,59.4,46.9]],['L',[66.2,46.9]],['C',[65.2,39.4,60.95,34.25]]]);
		motifs.set("D", [['M',[28.5,31.1]],['C',[43.8,30.95,50.9,38.05]],['C',[58,45.15,57.9,61]],['C',[58,76.9,50.9,83.95]],['C',[43.8,91.1,28.5,90.9]],['L',[14,90.9]],['L',[14,31.1]],['L',[28.5,31.1]],['M',[7.25,25.3]],['L',[7.25,96.7]],['L',[31.95,96.7]],['C',[48.05,96.3,56.35,87.4]],['C',[64.65,78.55,64.7,61]],['C',[64.65,43.5,56.35,34.6]],['C',[48.05,25.7,31.95,25.3]],['L',[7.25,25.3]]]);
		motifs.set("E", [['M',[56.5,25.3]],['L',[7.25,25.3]],['L',[7.25,96.7]],['L',[57.05,96.7]],['L',[57.05,90.9]],['L',[14,90.9]],['L',[14,62.7]],['L',[53.8,62.7]],['L',[53.8,56.9]],['L',[14,56.9]],['L',[14,31.1]],['L',[56.5,31.1]],['L',[56.5,25.3]]]);
		motifs.set("F", [['M',[52.5,25.3]],['L',[7.25,25.3]],['L',[7.25,96.7]],['L',[14,96.7]],['L',[14,62.7]],['L',[48.2,62.7]],['L',[48.2,56.9]],['L',[14,56.9]],['L',[14,31.1]],['L',[52.5,31.1]],['L',[52.5,25.3]]]);
		motifs.set("G", [['M',[57.2,39.25]],['C',[60,43.3,60.5,47.5]],['L',[67.3,47.5]],['C',[65.9,39.65,61.75,34.45]],['C',[57.55,29.15,51.3,26.5]],['C',[45.05,23.8,37.5,23.8]],['C',[29.05,23.85,22.75,26.9]],['C',[16.4,29.9,12.2,35.1]],['C',[8,40.3,5.9,46.95]],['C',[3.8,53.6,3.8,60.95]],['C',[3.8,68.4,5.9,75]],['C',[8,81.7,12.2,86.95]],['C',[16.4,92.1,22.75,95.15]],['C',[29.05,98.15,37.5,98.2]],['C',[42.7,98.2,47.4,96.7]],['C',[52.15,95.2,55.95,92]],['C',[59.75,88.8,62.2,83.7]],['L',[62.4,83.7]],['L',[63.3,96.7]],['L',[68.2,96.7]],['L',[68.2,60.35]],['L',[37.9,60.35]],['L',[37.9,66.2]],['L',[62.2,66.2]],['C',[62.3,73.8,59.4,79.7]],['C',[56.55,85.6,51,89]],['C',[45.4,92.35,37.5,92.4]],['C',[30.4,92.35,25.35,89.65]],['C',[20.2,87.05,16.95,82.55]],['C',[13.65,78.05,12.15,72.5]],['C',[10.6,66.9,10.6,60.95]],['C',[10.6,55.05,12.15,49.5]],['C',[13.65,43.9,16.95,39.4]],['C',[20.2,35,25.35,32.3]],['C',[30.4,29.65,37.5,29.6]],['C',[44.35,29.7,49.3,32.45]],['C',[54.3,35.15,57.2,39.25]]]);
		motifs.set("H", [['M',[56.4,25.3]],['L',[56.4,56.25]],['L',[14,56.25]],['L',[14,25.3]],['L',[7.25,25.3]],['L',[7.25,96.7]],['L',[14,96.7]],['L',[14,62.1]],['L',[56.4,62.1]],['L',[56.4,96.7]],['L',[63.2,96.7]],['L',[63.2,25.3]],['L',[56.4,25.3]]]);
		motifs.set("I", [['M',[7.7,25.3]],['L',[7.7,96.7]],['L',[14.5,96.7]],['L',[14.5,25.3]],['L',[7.7,25.3]]]);
	...
	private function initializeMotifsLowercase():Void {
		...
		motifs.set("v", [['M',[0.2,45.1]],['L',[20.1,96.7]],['L',[26.8,96.7]],['L',[46.1,45.1]],['L',[39.6,45.1]],['L',[23.6,90.4]],['L',[23.4,90.4]],['L',[7.2,45.1]],['L',[0.2,45.1]]]);
		motifs.set("w", [['M',[66.6,45.1]],['L',[53.35,89.3]],['L',[53.15,89.3]],['L',[40.6,45.1]],['L',[33.5,45.1]],['L',[20.9,89.3]],['L',[20.7,89.3]],['L',[7.5,45.1]],['L',[0.8,45.1]],['L',[17.4,96.7]],['L',[24.25,96.7]],['L',[36.85,53.3]],['L',[37.1,53.3]],['L',[49.8,96.7]],['L',[56.7,96.7]],['L',[73.3,45.1]],['L',[66.6,45.1]]]);
		motifs.set("x", [['M',[1.6,45.1]],['L',[20.1,69.9]],['L',[0.1,96.7]],['L',[7.9,96.7]],['L',[23.8,74.95]],['L',[40,96.7]],['L',[48,96.7]],['L',[27.9,69.8]],['L',[46.5,45.1]],['L',[38.55,45.1]],['L',[24.2,64.65]],['L',[9.5,45.1]],['L',[1.6,45.1]]]);
