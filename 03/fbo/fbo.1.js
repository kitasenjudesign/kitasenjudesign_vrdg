var FBO = function( exports ){
    ...
    exports.update = function(){
        ...
        if(exports.flag){
            ...
            exports.simuMat.uniforms.texture.value = rtt;
            exports.particles.material.uniforms.positions.value = rtt;
        }else{
            exports.renderer.render( scene, orthoCamera, rtt2, true );
            exports.simuMat.uniforms.texture.value = rtt2;
            exports.particles.material.uniforms.positions.value = rtt2;
        }
