...
faces.MaeShaderMaterial = function() {
	...
	if(faces.MaeShaderMaterial._texture1 == null) faces.MaeShaderMaterial._texture1 = THREE.ImageUtils.loadTexture("face/dede_face_diff.png");
	this._indecies = [];
	this._freq = [];
	var _g1 = 0;
...
faces.MaeShaderMaterial.prototype = $extend(THREE.ShaderMaterial.prototype,{
	changeTexture: function() {
		if(faces.MaeShaderMaterial._colorTextures == null) faces.MaeShaderMaterial._colorTextures = [THREE.ImageUtils.loadTexture("grade/grade.png"),THREE.ImageUtils.loadTexture("grade/grade2.png"),THREE.ImageUtils.loadTexture("grade/grade3.png"),THREE.ImageUtils.loadTexture("grade/grade4.png"),THREE.ImageUtils.loadTexture("grade/grade8.png")];
