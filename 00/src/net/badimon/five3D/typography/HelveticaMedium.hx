...
package C:\Users\nabe\Documents\private\moji\src\net\badimon\five3D\typography ;

/**
 * The HelveticaMedium class contains the drawing data associated with the Helvetica Medium typography.
 */
class HelveticaMedium extends Typography3D {

	private static var _instance:HelveticaMedium;

	/**
	 * Returns a unique HelveticaMedium instance to be passed to a DynamicText3D object.
	 * Use this property instead of the constructor to avoid the repetition of the drawing data initialization on new instances creation.
	 */
	//public static var instance(getInstance, null):HelveticaMedium;
	//private static function getInstance():HelveticaMedium {
	//	if(_instance == null) _instance = new HelveticaMedium();
	//	return _instance;
	//a}

	/**
	 * Creates a new HelveticaMedium instance.
	 */
	public function new() {
		super();
	...
	private function initializeMotifsPunctuation():Void {
		...
		motifs.set("'", [['M',[8.8,23.8]],['L',[8.8,52.05]],['L',[19,52.05]],['L',[19,23.8]],['L',[8.8,23.8]]]);
		motifs.set("(", [['M',[8.7,44.35]],['C',[5,56.1,4.95,68.2]],['C',[5,77.7,6.9,85.85]],['C',[8.8,93.95,12,100.95]],['C',[15.3,108,19.3,114.3]],['L',[28.6,114.3]],['C',[22.3,103.65,19.3,92.15]],['C',[16.3,80.7,16.3,68.2]],['C',[16.3,55.7,19.45,44.25]],['C',[22.6,32.8,28.6,22.1]],['L',[19.3,22.1]],['C',[12.45,32.65,8.7,44.35]]]);
		motifs.set(")", [['M',[8.55,22.1]],['L',[-0.8,22.1]],['C',[5.5,32.8,8.55,44.3]],['C',[11.5,55.8,11.5,68.3]],['C',[11.5,80.8,8.4,92.2]],['C',[5.2,103.65,-0.8,114.3]],['L',[8.55,114.3]],['C',[15.4,103.8,19.15,92.1]],['C',[22.85,80.45,22.9,68.3]],['C',[22.85,58.75,20.95,50.65]],['C',[19.05,42.55,15.8,35.55]],['C',[12.55,28.45,8.55,22.1]]]);
		motifs.set("*", [['M',[4.1,31.55]],['L',[1.9,38]],['L',[13,41.85]],['L',[6,51.2]],['L',[11.6,55.1]],['L',[18.4,45.3]],['L',[25.5,55.1]],['L',[30.8,51.2]],['L',[23.85,41.85]],['L',[35.2,38]],['L',[32.8,31.55]],['L',[21.9,35.85]],['L',[21.9,23.8]],['L',[15.1,23.8]],['L',[15.1,35.85]],['L',[4.1,31.55]]]);
		motifs.set("+", [['M',[24.9,44.55]],['L',[24.9,64.8]],['L',[4.8,64.8]],['L',[4.8,75]],['L',[24.9,75]],['L',[24.9,95.2]],['L',[35.1,95.2]],['L',[35.1,75]],['L',[55.2,75]],['L',[55.2,64.8]],['L',[35.1,64.8]],['L',[35.1,44.55]],['L',[24.9,44.55]]]);
		motifs.set(",", [['M',[6.9,95.2]],['L',[13.75,95.2]],['C',[13.85,98.5,12.2,101.25]],['C',[10.6,104,7.3,104.9]],['L',[7.3,111]],['C',[13.35,109.75,17,105.55]],['C',[20.6,101.4,20.8,95.2]],['L',[20.8,81.7]],['L',[6.9,81.7]],['L',[6.9,95.2]]]);
		motifs.set("-", [['M',[4.9,73.35]],['L',[34,73.35]],['L',[34,62.6]],['L',[4.9,62.6]],['L',[4.9,73.35]]]);
		motifs.set(".", [['M',[6.9,95.2]],['L',[20.8,95.2]],['L',[20.8,81.7]],['L',[6.9,81.7]],['L',[6.9,95.2]]]);
		motifs.set("/", [['M',[26.5,22.1]],['L',[-2.2,96.9]],['L',[8.7,96.9]],['L',[37.4,22.1]],['L',[26.5,22.1]]]);
		motifs.set(":", [['M',[6.9,44.6]],['L',[6.9,58.1]],['L',[20.8,58.1]],['L',[20.8,44.6]],['L',[6.9,44.6]],['M',[6.9,95.2]],['L',[20.8,95.2]],['L',[20.8,81.7]],['L',[6.9,81.7]],['L',[6.9,95.2]]]);
		motifs.set(");", [['M',[6.9,44.6]],['L',[6.9,58.1]],['L',[20.8,58.1]],['L',[20.8,44.6]],['L',[6.9,44.6]],['M',[6.9,95.2]],['L',[13.75,95.2]],['C',[13.85,98.5,12.2,101.25]],['C',[10.6,104,7.3,104.9]],['L',[7.3,111]],['C',[13.35,109.75,17,105.55]],['C',[20.6,101.4,20.8,95.2]],['L',[20.8,81.7]],['L',[6.9,81.7]],['L',[6.9,95.2]]]);
		motifs.set("<", [['M',[4.6,73.5]],['L',[55.35,96.05]],['L',[55.35,85.85]],['L',[17.95,69.9]],['L',[55.35,54.05]],['L',[55.35,43.85]],['L',[4.6,66.35]],['L',[4.6,73.5]]]);
		motifs.set("=", [['M',[4.8,85.1]],['L',[55.2,85.1]],['L',[55.2,74.9]],['L',[4.8,74.9]],['L',[4.8,85.1]],['M',[4.8,64.95]],['L',[55.2,64.95]],['L',[55.2,54.7]],['L',[4.8,54.7]],['L',[4.8,64.95]]]);
		motifs.set(">", [['M',[4.6,96.05]],['L',[55.35,73.5]],['L',[55.35,66.35]],['L',[4.6,43.85]],['L',[4.6,54.05]],['L',[42,69.9]],['L',[4.6,85.85]],['L',[4.6,96.05]]]);
		motifs.set("?", [['M',[47.75,31.35]],['C',[44.85,26.85,39.95,24.5]],['C',[35.05,22.1,28.9,22.1]],['C',[21.55,22.15,16.15,25.2]],['C',[10.75,28.2,7.85,33.7]],['C',[4.95,39.15,4.95,46.5]],['L',[16.3,46.5]],['C',[16.3,39.7,19.3,35.7]],['C',[22.25,31.7,28.35,31.65]],['C',[30.25,31.6,32.5,32.7]],['C',[34.75,33.75,36.45,36.2]],['C',[38.1,38.7,38.2,42.7]],['C',[38.15,46.05,37.05,48.2]],['C',[35.95,50.4,34.1,52.05]],['L',[30.1,55.5]],['C',[27.45,57.75,25.75,60.25]],['C',[24,62.75,23.15,66.4]],['C',[22.3,70.05,22.3,75.8]],['L',[33.1,75.8]],['C',[33.1,71.1,34.25,68.15]],['C',[35.35,65.15,37.35,63.05]],['C',[39.3,60.95,41.9,58.9]],['L',[46.15,55.05]],['C',[48.1,53,49.35,50]],['C',[50.65,46.95,50.7,42.3]],['C',[50.65,35.85,47.75,31.35]],['M',[20.8,95.2]],['L',[34.2,95.2]],['L',[34.2,82.7]],['L',[20.8,82.7]],['L',[20.8,95.2]]]);
		motifs.set("@", [['M',[41.6,22.1]],['C',[34.1,22.15,27.5,24.9]],['C',[20.85,27.65,15.75,32.6]],['C',[10.7,37.5,7.8,44.05]],['C',[4.95,50.55,4.9,58.2]],['C',[5,69.7,9.95,78.4]],['C',[14.9,87.1,23.3,92]],['C',[31.7,96.8,42.1,96.9]],['C',[51.45,96.85,59.3,92.55]],['C',[67.1,88.3,72,80.5]],['L',[65,80.5]],['C',[60.9,85.2,55,87.8]],['C',[49.1,90.35,42.55,90.4]],['C',[34,90.35,27.3,86.5]],['C',[20.65,82.65,16.8,75.5]],['C',[13,68.4,12.9,58.6]],['C',[12.95,50.2,16.55,43.4]],['C',[20.15,36.65,26.6,32.65]],['C',[33.05,28.7,41.6,28.6]],['C',[48.95,28.65,55.05,31.55]],['C',[61.05,34.4,64.65,39.75]],['C',[68.2,45.1,68.3,52.6]],['C',[68.25,58.75,66.3,63.6]],['C',[64.4,68.5,61.45,71.3]],['C',[58.5,74.15,55.3,74.2]],['C',[54,74.15,53.6,73.15]],['C',[53.25,72.05,53.5,70.5]],['C',[53.75,68.9,54.3,67.3]],['L',[61.5,41]],['L',[54.5,41]],['L',[52.75,46.7]],['C',[50.85,42.9,47.95,41.2]],['C',[45.05,39.5,41.5,39.5]],['C',[36.55,39.55,32.5,41.75]],['C',[28.5,44,25.65,47.7]],['C',[22.7,51.4,21.15,56]],['C',[19.6,60.6,19.6,65.35]],['C',[19.65,69.7,21.55,73.3]],['C',[23.45,76.8,26.7,78.95]],['C',[30,81.05,34.2,81.1]],['C',[37.45,81,40.4,79.35]],['C',[43.3,77.7,45.4,75.4]],['L',[45.6,75.4]],['C',[45.8,78.3,47.45,79.75]],['C',[49.1,81.2,51.5,81.2]],['C',[54.65,81.2,58.6,79.4]],['C',[62.6,77.5,66.35,73.8]],['C',[70.05,70.15,72.55,64.55]],['C',[75,58.9,75.1,51.4]],['C',[75.05,44.9,72.35,39.6]],['C',[69.7,34.2,65.05,30.3]],['C',[60.35,26.4,54.35,24.25]],['C',[48.35,22.15,41.6,22.1]],['M',[30.2,71.05]],['C',[28.15,68.55,28.1,64.5]],['C',[28.1,60.65,29.8,56.65]],['C',[31.55,52.6,34.6,49.9]],['C',[37.7,47.1,41.9,47]],['C',[45.2,47.1,47.45,49.65]],['C',[49.7,52.2,49.8,55.8]],['C',[49.8,58.6,48.8,61.65]],['C',[47.75,64.75,45.9,67.4]],['C',[44.1,70.1,41.55,71.8]],['C',[39.05,73.5,36.1,73.55]],['C',[32.35,73.5,30.2,71.05]]]);
		motifs.set("[", [['M',[7.25,22.1]],['L',[7.25,114.3]],['L',[29.5,114.3]],['L',[29.5,105.3]],['L',[18,105.3]],['L',[18,31.1]],['L',[29.5,31.1]],['L',[29.5,22.1]],['L',[7.25,22.1]]]);
		motifs.set("\\", [['M',[37.4,96.9]],['L',[8.7,22.1]],['L',[-2.2,22.1]],['L',[26.5,96.9]],['L',[37.4,96.9]]]);
		motifs.set("]", [['M',[11.6,31.1]],['L',[11.6,105.3]],['L',[0.15,105.3]],['L',[0.15,114.3]],['L',[22.4,114.3]],['L',[22.4,22.1]],['L',[0.15,22.1]],['L',[0.15,31.1]],['L',[11.6,31.1]]]);
		motifs.set("^", [['M',[26.4,25.2]],['L',[8.4,61.7]],['L',[18.6,61.7]],['L',[30.05,37]],['L',[41.4,61.7]],['L',[51.6,61.7]],['L',[33.6,25.2]],['L',[26.4,25.2]]]);
		motifs.set("_", [['M',[50,102.7]],['L',[0,102.7]],['L',[0,107.7]],['L',[50,107.7]],['L',[50,102.7]]]);
		motifs.set("`", [['M',[10.55,22.1]],['L',[-2.9,22.1]],['L',[11.35,36.4]],['L',[19.65,36.4]],['L',[10.55,22.1]]]);
		*/
	}

	private function initializeWidthsUppercase():Void {
		widths.set("A", 67);
		widths.set("B", 70);
		widths.set("C", 72);
		widths.set("D", 72);
	...
	private function initializeWidthsLowercase():Void {
		widths.set("a", 56);
		widths.set("b", 61);
		widths.set("c", 56);
		widths.set("d", 61);
	...
	private function initializeWidthsNumbers():Void {
		widths.set("0", 56);
		widths.set("1", 56);
		widths.set("2", 56);
		widths.set("3", 56);
	...
	private function initializeWidthsPunctuation():Void {
		widths.set(" ", 28);
		widths.set("!", 28);
		widths.set("\"", 44);
		widths.set("#", 56);
